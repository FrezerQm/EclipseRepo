...
import tek.sdet.framework.config.EdgeHeadless;
import tek.sdet.framework.config.FirefoxBrowser;
import tek.sdet.framework.config.FirefoxHeadless;
import tek.sdet.framework.utilities.ReadYamlFiles;

public class BaseSetup {
	private static WebDriver webDriver;
	private final ReadYamlFiles enviromentVariables;
	public static Logger logger; //import org.slf4j.Logger interface 
